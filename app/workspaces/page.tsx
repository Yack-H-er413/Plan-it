            ...
            <div>
              <div className="mb-2 flex flex-wrap items-center gap-2">
                ...
                {status === "authenticated" ? (
                  ...
                  <Badge variant="warn">Sign in to enable sync later</Badge>
                )}
              </div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-zinc-700 md:text-base">
                Each workspace is a separate planner. Changes autosave. When Google sync is
                implemented, workspaces will sync to your account.
              </p>
            </div>
